        ...
        return (this.discountsData().map((discount) => {
            return (
                <div key={Math.random()} className="cardBorder col s12 m12 l12" style={{ 'backgroundColor': '#ecf0f1' }}>
                    <div id={discount._id + 'deny'} className={discount.responded && !discount.confirmed ? 'z2 transparentRed center-align' : 'hide'}>

                    </div>
                    <div id={discount._id + 'accept'} className={discount.responded && discount.confirmed ? 'z2 transparentGreen center-align' : 'hide'}>

                    </div>
                    <div className="col s5 m5 l5 cardBorder noPadding">
                        <div className="padding5 click col s6 m6 l6 center-align saqiBorder">Truck# {discount.truckNumber}</div>
                    ...
                    <div className="col s4 m4 l4 cardBorder noPadding">
                        ...
                        <div className=" click  col s6 m6 l6 center-align white-text" style={{ 'backgroundColor': '#1abc9c' }} onClick={() => this.accept(discount)} >
                            <i className="material-icons padding5z">
                                check_circle
                            </i>
                        </div>
