        ...
        return (
            <div className="center-text">
                ...
                <div>
                    <span>
                        <strong>
                            Confirmation e-mail was sent to your e-mail
                            address.&nbsp;
                        </strong>
                    </span>
                </div>
                ...
                <div>
                    <span>
                        <strong>
                            You can always call us, e-mail and text if you have
                            any questions.&nbsp;
                        </strong>
                    </span>
                </div>
                ...
                <div>
                    <div>
                        <span>
                            {this.state.company.name} -- Moving you with pride
                            since 2006!
                        </span>
                    </div>
                </div>
                <div>
                    <div>
                        <span>
                            ...
                            <a
                                style={colorStyle}
                                href={'tel:' + this.state.company.phoneNumber}
                                target="_blank"
                    ...
                    <div>
                        <span>
                            ...
                            <a
                                ...
                                href={'http://' + this.state.company.url}
                                target="_blank"
                                rel="noopener noreferrer">
                                {'http://' + this.state.company.url}
                            </a>
                        </span>
                    </div>
