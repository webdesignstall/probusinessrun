...
export default class MoverForm extends Component {
    ...
    saveDataToState() {
        let mover = [];
        this.props.id
            ? mover = Meteor.users.find({ _id: this.props.id }).fetch()[0]
            : null;
            ...
            <div className={this.props.show ? 'row' : 'hide'}>
                ...
                <form key={this.props.id + 'form'} id="mover_form" >
                    <div key={this.props.id + 'firstNameDiv'} className="input-field valideyn col s12 m6 l3">
                        ...
                        <input key={this.props.id + 'firstName'} onChange={(e) => this.inputChange('firstName', e)} value={this.state.obj.firstName !== '' ? this.state.obj.firstName : ''} placeholder="First Name" type="text" className="validate" />
                        <label className="active" htmlFor="first_name">First Name</label>
                    </div>
                    <div key={this.props.id + 'lastNameDiv'} className="input-field valideyn col s12 m6 l3">
                        <i className="material-icons isare">person</i>
                        <input key={this.props.id + 'lastName'} onChange={(e) => this.inputChange('lastName', e)} value={this.state.obj.lastName || ''} placeholder="Last Name" type="text" className="validate" />
                    ...
                    <div key={this.props.id + 'phoneNumberDiv'} className="input-field valideyn col s12 m6 l3">
                        ...
                        <input key={this.props.id + 'phoneNumber'} onChange={(e) => this.inputChange('phoneNumber', e)} value={this.state.obj.phoneNumber || ''} placeholder="Phone Number" type="number" className="validate" />
                    ...
                    <div key={this.props.id + 'snnDiv'} className="input-field valideyn col s12 m6 l3">
                        ...
                        <input key={this.props.id + 'snn'} onChange={(e) => this.inputChange('snn', e)} value={this.state.obj.snn || ''} placeholder="SNN" type="number" className="validate" />
                    ...
                    <div key={this.props.id + 'emailDiv'} className="input-field valideyn col s12 m6 l6">
                        ...
                        <input key={this.props.id + 'email'} onChange={(e) => this.inputChange('email', e)} value={this.state.obj.email || ''} placeholder="Email" type="text" className="validate" />
                    ...
                    <div key={this.props.id + 'addressDiv'} className="input-field valideyn col s12 m6 l6">
                        ...
                        <input key={this.props.id + 'address'} onChange={(e) => this.inputChange('address', e)} value={this.state.obj.address || ''} placeholder="Address" type="text" className="validate" />
