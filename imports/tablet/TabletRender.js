      ...
      this.state.vurulmusIs.length > 0 ? this.state.vurulmusIs[0] : null;
        ...
        if (typeOfPayment === 'cash') {
            if (inputAmount < 0 || inputAmount === 0) {
                ...
                amountOf =
          ((this.payCash - deposit - inputAmount) / (this.payCash - deposit)) *
          (this.payCard - deposit);
            ...
            if (inputAmount < 0 || inputAmount === 0) {
                ...
                amountOf =
          ((this.payCard - deposit - inputAmount) / (this.payCard - deposit)) *
        ...
        this.x = Tracker.autorun(() => {
          ...
          checks.myResponsibility
                ...
                this.state.paperBundles,
                            ...
                            additionalSignature:
                is.additionalSignature && is.additionalSignature.length > 0
                    ? is.additionalSignature
                    : [],
                            discount:
                is.discount && is.discount.length > 0 ? is.discount : [],
                            additionalCharge:
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div
                    id="tablet-is-render_"
                    className={this.state.survey ? 'hide' : 'tabletJobRendered'}
                >
                    <a
                        href="#"
                        id="close-duymesi-id"
                        className={this.state.survey ? 'hide' : 'close-duymesi'}
                    >
            CLOSE THIS PAGE X
                    </a>
                    <div>
                        ...
                        <div id="tabler-yuxari">
                            <table>
                              ...
                              License Number: BEARHFTI 0191555
                                                            <br />
                                                            <hr />
                              Customer Name: {is.clientFirstName}{' '}
                                                            {is.clientLastName}
                                                            <br />
                                                            <span
                                                                className={
                                                                    is.cardHolderInfo &&
                                  is.cardHolderInfo.firstName
                                                                        ? ''
                                                                        : 'hide'
                                                                }
                                                            >
                                  ...
                                  is.cardHolderInfo.lastName}
                                        ...
                                        <td className="sag card__" style={{ marginRight: '20px' }}>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                          &nbsp; {takenBy ? takenBy.profile.firstName : ''}
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <div className="row">
                                ...
                                >
                  SHIPPER (CUSTOMER) IS REQUESTED TO READ THIS DOCUMENT
                  CAREFULLY, INCLUDING TERMS AND CONDITIONS, BEFORE SIGNING. BY
                  SIGNING THIS CONTRACT, THIS WILL CONFIRM INSTRUCTIONS AND
                  AUTHORIZE{' '}
                                    {is.companyInfo === undefined ? '' : is.companyInfo.name} TO
                  MOVE, SHIP, PACK, STORE, AND/OR PERFORM THE SERVICES HEREIN.
                                </div>
                            </div>
                            <div className="clear" />
                  ...
                  NOTE: Additional charges for storage, extra handling, and
                  transportation will accrue if goods are not promptly accepted
                                </div>
                                <div className="clear" />
                      ...
                      Moving Size: {this.state.movingSizeList[is.movingSize]}
                                        ...
                                        <div className="col s6 m6 l6">
                      Travel Fee (one time):{' '}
                                            {is.gasFee && is.gasFee > 0 ? '$' + is.gasFee : 'Waived'}
                                            <br />
                      Double Drive Time:{' '}
                                            {is.doubleDrive === 'yes' ? 'Yes' : 'Waived'}
                                            <br />
                      ...
                      Not to Exceed Price: ${is.price}
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp;
                          ...
                          No
                                        ...
                                        <div className="card__ valign-wrapper">
                                            <div className="col s6 m6 l6">
                        Was the moving date agreed to between you &amp; the
                        carrier less than 3 days prior to the day of your move?
                                            </div>
                                            <div className="col s6 m6 l6 center-align">
                                                <button
                                                    className={
                            ...
                            is.threeDayPrior === false
                                                    ...
                                                    onClick={() =>
                                                        this.requirementEntirely(true, 'threeDayPrior')
                                                    }
                                                >
                          Yes
                                                </button>
                        &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            is.threeDayPrior === false
                                                    ...
                                                    onClick={() =>
                                                        this.requirementEntirely(false, 'threeDayPrior')
                                                    }
                                                >
                          No
                                                </button>
                    ...
                    VALUATION OPTIONS: VALUATION DECLARATION &amp; DISCLAIMER
                        ...
                        per $100
                                ...
                                <div className="card__ warning">
                  CUSTOMER AGREES THAT TITLE TO ALL PACKING MATERIALS AND OTHER
                  PROPERTY SOLD TO CUSTOMER PASSES TO CUSTOMER PRIOR TO THE
                  TRANSPORTATION OF SUCH PROPERTY TO THE CUSTOMER BY CARRIER.
                  THIS ALSO MEANS THAT ANY PACKING MATERIALS OR TRASH/DONATION
                  ITEMS ARE YOUR OWN PROPERTY AND, AS SUCH, CARRIER IS NOT
                  RESPONSIBLE FOR THE DISPOSAL AND/OR REMOVAL OF THESE ITEMS.
                                    <br />
                  Read and Agree
                                    <input
                                        type="checkbox"
                                ...
                                <div className="card__ warning">
                  NOTE: All cargo is subject to a Mover’s Lien as described by
                  the CPUC until entire amount due is paid IN FULL. Any
                  loss/damage claims must be received in writing AFTER your move
                  and DO NOT exempt you from paying the total amount due as
                  outlined above.
                                    <br />
                  Read and Agree
                                    <input
                                ...
                                <div className="card__ warning">
                  I understand that it’s my responsibility to hold a parking
                  space for the moving truck at each location. Failure to do so
                  will result in my being held responsible to pay for any, and
                  all, parking tickets/fines resulting from my negligence to do
                  so.
                                    <br />
                  Read and Agree
                                    <input
                  ...
                  BY SIGNING BELOW, I {is.clientFirstName} {is.clientLastName},
                  CONFIRM THAT THE INFORMATION ABOVE IS TRUE AND CORRECT TO THE
                  BEST OF MY KNOWLEDGE. <br />
                  SHIPPER’S (CUSTOMER’S) SIGNATURE:
                                    <br />
                  DATE:{' '}
                                    {this.state.initSign
                                        ? moment(this.state.initSignDate).format(
                                            'MM/DD/YYYY hh:mm a'
                                        )
                      ...
                      Submit AND START
                                    ...
                                    <div className="wrapper">
                                        <canvas
                                            ...
                                            className={
                                                (this.state.initSign ? 'hide' : '') + ' signature-pad'
                                            }
                                            width={400}
                                            height={200}
                                        />
                    ...
                    Clear
                        ...
                        <div
                            id="secondStep"
                            className={this.state.initSign ? 'card__' : 'hide card__'}
                        >
                            <div
                                className={
                                    is.isPayed
                      ...
                      ={' '}
                                            {is.smallItemPacking && is.smallItemPacking < 0
                                                ...
                                                : is.smallItemPacking > 0
                                                    ? '$' +
                          (is.smallItemPacking +
                            (this.state.totalPul ? this.state.totalPul : 0))
                                                    : 'Waived'}
                                        </span>
                                    </li>
                                    <li className="collection-item blue">
                    Extra Large/Heavy Item Fee:
                                    ...
                                    <li
                                        className={is.gasFee > 0 ? 'collection-item blue' : 'hide'}
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="input-field">
                                                <input
                                                    ...
                                                    value={
                                                        is.cashPayed ||
                            (this.state.payCash > 0 ? this.state.payCash : '')
                                                    }
                                                />
                                            </div>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="input-field">
                                                <input
                                                    ...
                                                    value={
                                                        is.cardPayed ||
                            (this.state.payCard > 0 ? this.state.payCard : '')
                                                    }
                                                />
                                            </div>
                  ...
                  I agree that this move was completed to my satisfaction and
                  that none of my items were damaged or broken.
                                </div>
                                {/* musteri signature */}
                    ...
                    Clear
                                ...
                                <div
                                    className={
                                        is.finished ? 'hide' : ' col s12 m12 l12 margin-top'
                                    }
